...
/// @nodoc
@JsonSerializable()
class _$_Repos extends _Repos {
  const _$_Repos({required this.id, required this.name, this.description})
      : super._();
  ...
  @override
  String toString() {
    return 'Repos(id: $id, name: $name, description: $description)';
  }
...
abstract class _Repos extends Repos {
  const factory _Repos(
      {required final int id,
      required final String name,
      final String? description}) = _$_Repos;
  const _Repos._() : super._();
